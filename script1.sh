wget https://github.com/nginx/nginx/archive/release-1.17.9.tar.gz https://github.com/aperezdc/ngx-fancyindex/archive/v0.4.4.tar.gz https://www.openssl.org/source/openssl-1.1.1d.tar.gz http://zlib.net/zlib-1.2.11.tar.gz https://ftp.pcre.org/pub/pcre/pcre-8.44.tar.gz
